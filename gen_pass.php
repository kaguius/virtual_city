...
$result_tender = mysql_query("select first_name, last_name from user_profiles where email_address = '$genemail'");
...
$mailto = "$genemail" ;
$subject = "[e-kodi Property Manager] Your new password" ;
